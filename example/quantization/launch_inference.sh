...
python imagenet_inference.py --symbol-file=./model/imagenet1k-vgg-16-symbol.json --param-file=./model/imagenet1k-vgg-16-0000.params --label-name='prob_label' --rgb-mean=0,0,0 --num-skipped-batches=50 --num-inference-batches=500 --dataset=./data/val_256_q90.rec

python imagenet_inference.py --symbol-file=./model/imagenet1k-vgg-16-quantized-symbol.json --param-file=./model/imagenet1k-vgg-16-quantized-0000.params --label-name='prob_label' --rgb-mean=0,0,0 --num-skipped-batches=50 --num-inference-batches=500 --dataset=./data/val_256_q90.rec

python imagenet_inference.py --symbol-file=./model/imagenet1k-vgg-16-quantized-5batches-naive-symbol.json --param-file=./model/imagenet1k-vgg-16-quantized-0000.params --label-name='prob_label' --rgb-mean=0,0,0 --num-skipped-batches=50 --num-inference-batches=500 --dataset=./data/val_256_q90.rec
python imagenet_inference.py --symbol-file=./model/imagenet1k-vgg-16-quantized-10batches-naive-symbol.json --param-file=./model/imagenet1k-vgg-16-quantized-0000.params --label-name='prob_label' --rgb-mean=0,0,0 --num-skipped-batches=50 --num-inference-batches=500 --dataset=./data/val_256_q90.rec
python imagenet_inference.py --symbol-file=./model/imagenet1k-vgg-16-quantized-50batches-naive-symbol.json --param-file=./model/imagenet1k-vgg-16-quantized-0000.params --label-name='prob_label' --rgb-mean=0,0,0 --num-skipped-batches=50 --num-inference-batches=500 --dataset=./data/val_256_q90.rec

python imagenet_inference.py --symbol-file=./model/imagenet1k-vgg-16-quantized-5batches-entropy-symbol.json --param-file=./model/imagenet1k-vgg-16-quantized-0000.params --label-name='prob_label' --rgb-mean=0,0,0 --num-skipped-batches=50 --num-inference-batches=500 --dataset=./data/val_256_q90.rec
python imagenet_inference.py --symbol-file=./model/imagenet1k-vgg-16-quantized-10batches-entropy-symbol.json --param-file=./model/imagenet1k-vgg-16-quantized-0000.params --label-name='prob_label' --rgb-mean=0,0,0 --num-skipped-batches=50 --num-inference-batches=500 --dataset=./data/val_256_q90.rec
python imagenet_inference.py --symbol-file=./model/imagenet1k-vgg-16-quantized-50batches-entropy-symbol.json --param-file=./model/imagenet1k-vgg-16-quantized-0000.params --label-name='prob_label' --rgb-mean=0,0,0 --num-skipped-batches=50 --num-inference-batches=500 --dataset=./data/val_256_q90.rec
